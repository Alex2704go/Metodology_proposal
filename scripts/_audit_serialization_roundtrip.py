...
DATA=ROOT/'derived/builder_audit_serialization_roundtrip.jsonl.gz'
OUT=ROOT/'derived/builder_audit_serialization_roundtrip.npz'; MAN=ROOT/'derived/builder_audit_serialization_roundtrip_manifest.json'; REPORT=ROOT/'reports/builder_audit_serialization_roundtrip.md'
SEED=420042
