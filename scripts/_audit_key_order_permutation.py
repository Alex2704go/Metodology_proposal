...
DATA=ROOT/'derived/builder_audit_key_order_permutation.jsonl.gz'
OUT=ROOT/'derived/builder_audit_key_order_permutation.npz'; MAN=ROOT/'derived/builder_audit_key_order_permutation_manifest.json'; REPORT=ROOT/'reports/builder_audit_key_order_permutation.md'
SEED=420042
