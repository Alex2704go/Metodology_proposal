...
DATA=ROOT/'derived/builder_audit_nested_object_permutation.jsonl.gz'
OUT=ROOT/'derived/builder_audit_nested_object_permutation.npz'; MAN=ROOT/'derived/builder_audit_nested_object_permutation_manifest.json'; REPORT=ROOT/'reports/builder_audit_nested_object_permutation.md'
SEED=420042
