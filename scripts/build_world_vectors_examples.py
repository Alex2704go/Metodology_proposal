...
DATA=ROOT/'derived/objects_blind_with_examples_3004.jsonl.gz'
OUT=ROOT/'derived/world_vectors_examples_3004.npz'; MAN=ROOT/'derived/world_vectors_examples_3004_manifest.json'; REPORT=ROOT/'reports/checkpoint_vector_qc_examples_3004.md'
SEED=420042
