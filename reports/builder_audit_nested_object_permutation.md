...
- Objects: **3000**
- Candidate organizational observables: **161**
- Retained organizational observables: **105**
...
- `capability_map`: 18
- `composition_shape`: 11
- `provenance_shape`: 1
- `scalar_observers`: 9
- `structure_numeric`: 20
- `structure_topology`: 5
- `symmetry_record`: 39
...
## Removed within-block |r| >= 0.995

- `structure.object_nodes` ≈ `structure.leaves`
- `structure.list_nodes` ≈ `structure.leaves`
- `structure.list_size_max` ≈ `structure.leaves`
- `structure.sites[].species[].occu.count` ≈ `structure.sites[].abc[].count`
